...
def getlist(url):
    ...
    try:
        ...
        res=requests.get(url, headers=header,cookies=cookies,timeout=20)
        print('第%s轮，第一次·网络状态码: '%i,res.status_code)
        #print(res.content.decode('utf-8'))
        pattern = re.compile('<span class="val" data-v-681cda67>(.*?)</span></span></div>', re.S)  # <img class="" src=
...
if __name__ == "__main__":
    ...
    url = 'https://www.qcc.com/web/search?key=%E5%B9%BF%E4%B8%9C%E6%B0%B8%E5%8A%9B%E6%B3%B5%E4%B8%9A%E6%9C%89%E9%99%90%E5%85%AC%E5%8F%B8'
