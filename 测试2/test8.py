...
if __name__ == "__main__":
    ...
    url = 'https://careers.tencent.com/tencentcareer/api/post/Query?timestamp=1613921061791&countryId=&cityId=&bgIds=&productId=&categoryId=&parentCategoryId=&attrId=&keyword=python&pageIndex=1&pageSize=100&language=zh-cn&area=cn'
    getlist(url)