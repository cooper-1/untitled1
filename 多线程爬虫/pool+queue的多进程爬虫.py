# -*-coding:  utf-8 -*-
# @Time    :  2021/1/14 20:33
# @Author  :  Cooper
# @FileName:  pool+queue的多进程爬虫.py
# @Software:  PyCharm
...
if __name__ == "__main__":
    startTime = time.time()
    manager=Manager()
    workQueue=manager.Queue(maxsize=4000)
    """使用concurrent.futures中ProcessPoolExecutor创建进程池，需要使用Queue来完成进程通信时，
    需要使用multiprocessing.Manager()中的Queue()，而不是multiprocessing.Queue()，否则会报错"""
