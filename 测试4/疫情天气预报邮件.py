...
def sendmail(result):
    ...
    msgText = MIMEText('<!DOCTYPE html> <html> <head> <meta charset="utf-8" /> <title>闰京的消息</title> </head> <body><font size=6> '  + result 
                       + '</font><'+'<br><img src="cid:image1"><br>', 'html', 'utf-8')
...
if __name__ == "__main__":
    schedule.every().day.at("07:55").do(getlist1)
    getlist1()
    ...
    schedule.every().day.at("08:01").do(getlist, url)
    getlist(url)
